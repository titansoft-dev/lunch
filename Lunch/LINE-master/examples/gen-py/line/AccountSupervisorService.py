...
class Processor(Iface, TProcessor):
  ...
  def process_getRSAKey(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("getRSAKey", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_notifyEmailConfirmationResult(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("notifyEmailConfirmationResult", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_registerVirtualAccount(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("registerVirtualAccount", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_requestVirtualAccountPasswordChange(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("requestVirtualAccountPasswordChange", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_requestVirtualAccountPasswordSet(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("requestVirtualAccountPasswordSet", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_unregisterVirtualAccount(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("unregisterVirtualAccount", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
