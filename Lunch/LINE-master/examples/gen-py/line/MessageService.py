...
class Processor(Iface, TProcessor):
  ...
  def process_fetchMessageOperations(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("fetchMessageOperations", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_getLastReadMessageIds(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("getLastReadMessageIds", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_multiGetLastReadMessageIds(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.e = e
    oprot.writeMessageBegin("multiGetLastReadMessageIds", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
