...
class Message:
  ...
  def __init__(self, from=None, to=None, toType=None, id=None, createdTime=None, deliveredTime=None, text=None, location=None, hasContent=None, contentType=None, contentPreview=None, contentMetadata=None,):
    self.from = from
    self.to = to
    self.toType = toType
    self.id = id
...
class NotificationItem:
  ...
  def __init__(self, id=None, from=None, to=None, fromChannel=None, toChannel=None, revision=None, createdTime=None, content=None,):
    self.id = id
    self.from = from
    self.to = to
